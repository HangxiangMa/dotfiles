...
log "The window list renders a #{@claude_status} badge when a Claude Code"
log "hook sets that window option (working / needs-input / done). With no"
log "such hook the slot stays empty — a harmless no-op."
