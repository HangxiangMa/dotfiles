return {
	...
	config = function()
		require("toggleterm").setup({
			...
			-- No default open_mapping; <leader>Tf/Tv/Th below cover the openers.
			...
			insert_mappings = false, -- no auto-mapping in insert mode (open_mapping unset)
			terminal_mappings = false, -- no auto-mapping inside the term buffer either
			persist_size = true,
